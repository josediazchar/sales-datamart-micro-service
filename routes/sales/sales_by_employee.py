...
from models import SalesByEmployees, SalesData, User
...
def sales_by_employee(
    ...
    """
        Calculates the total sales for each employee within a given date range.
        ...
        Returns:
        SalesByEmployees: An object containing the total sales for each employee.
